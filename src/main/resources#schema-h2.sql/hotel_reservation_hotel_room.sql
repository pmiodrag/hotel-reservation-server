...
CREATE TABLE `hotel_room` (
  ...
  CONSTRAINT `hotelid` FOREIGN KEY (`hotelid`) REFERENCES `hotel` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `hotel_room` VALUES (1,1,'Single',30),(2,1,'Double',45),(3,2,'Single',15);
...
-- Dump completed on 2017-06-15 19:57:24
